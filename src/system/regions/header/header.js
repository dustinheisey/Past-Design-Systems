...
export const leftImageHeader = html`
...
export const rightImageHeader = html`
  <div class="cover cover-nav">
    <main class="principle">
      <div class="sidebar sidebar-split gap-m">
        <div class="prose fixed">
...
export const centerHeader = html`
  <div class="cover cover-nav">
...
export const leftImageInverseHeader = html`
...
export const rightImageInverseHeader = html`
  <div class="cover cover-nav theme-dark">
    <main class="principle">
      <div class="sidebar sidebar-split gap-m">
        <div class="prose fixed">
...
export const leftInverseHeader = html`
  <div class="cover cover-nav theme-dark">
    <main class="principle prose">
          <p class="overline">Overline Text</p>
          <h1>landing page title</h1>
...
export const rightInverseHeader = html`
  <div class="cover cover-nav theme-dark">
    <div class="principle stack align-end">
      <div class=" prose">
        <p class="overline">Overline Text</p>
...
export const centerInverseHeader = html`
  <div class="cover cover-nav theme-dark">
    <div class="principle center prose">
      <p class="overline">Overline Text</p>
      <h1>landing page title</h1>
