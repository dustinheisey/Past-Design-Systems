...
export default {
  title: "Design System/Elements/Text/Headlines",
  argTypes: {
    variant: {
      control: "select",
...
export const Default = ({ variant }) =>
  html` <h1 class="${variant}-headline">Welcome to our website</h1> `;
...
export const PageHeadline = () =>
  html` <h1 class="page-headline">About Us</h1> `;
...
export const RegionHeadline = () =>
  html` <h2 class="region-headline">Our Services</h2> `;
...
export const SectionHeadline = () =>
  html` <h3 class="section-headline">Web Development</h3> `;
...
export const TitleHeadline = () =>
  html` <h4 class="title-headline">Our Team</h4> `;
