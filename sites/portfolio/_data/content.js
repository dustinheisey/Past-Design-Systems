module.exports = {
  ...
  about: {
    ...
    introduction: {
      ...
      img: {
        src: "./assets/images/about-bio.png",
        alt: "",
      },
    },
    skills: {
      ...
      skills: [
        ...
        { headline: "Semantic HTML", icon: "html-l" },
        { headline: "Responsive CSS", icon: "css-l" },
        {
        ...
        { headline: "Javascript", icon: "javascript-l" },
        { headline: "Progressive Web Apps", icon: "pwa-l" },
        {
  ...
  services: {
    ...
    introduction: {
      ...
      headline: "Balancing Marketing Goals, Accessibility, and Sustainability",
    ...
    branding: {
      ...
      img: {
        src: "./assets/images/branding-service.png",
        alt: "",
      },
    },
    design: {
      ...
      img: {
        src: "./assets/images/web-design-service.png",
        alt: "",
      },
    },
    optimization: {
      ...
      img: {
        src: "./assets/images/optimization-service.png",
        alt: "",
      },
    },
  },
  branding: {
    header: {
      ...
      img: {
        src: "./assets/images/branding-intro.png",
        alt: "",
      },
    },
    problem: {
    ...
    description: {
      ...
      img: {
        src: "./assets/images/branding-description.png",
        alt: "",
      },
    },
    plan: {
      overline: "Your Branding Journey",
      headline: "A Step-by-Step Process, from Initial Inquiry to Final Result",
      steps: [
        {
    ...
    transformation: {
      ...
      img: {
        src: "./assets/images/branding-transformation.png",
        alt: "",
      },
    },
    faqs: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "The timeline can vary depending on the scope of the project and your specific needs. Generally, this process spans several weeks, allowing time to understand your organization, develop a brand strategy, and create the necessary brand guidelines. I'll provide a more specific timeline once I've had a chance to assess your needs.",
        },
        {
          question: "Will I have input in the branding process?",
          answer:
            "Absolutely! I value your input and believe that collaboration is essential for creating a successful brand strategy. Throughout the process, I will communicate with you regularly, gather your feedback, and incorporate your ideas to ensure the final outcome aligns with your vision.",
        },
        {
          question: "What if we have limited resources?",
          answer:
            "I understand that many organizations operate with limited resources. That's why my process includes a focus on efficient resource management. I strive to create budget-friendly strategies and leverage digital tools for effective brand communication, making the most of what you have.",
        },
        {
          question: "How can we maintain brand consistency after your service?",
          answer:
            "After this service, you will have a solid brand strategy and clear brand guidelines. These tools will guide your organization's future communications, ensuring brand consistency across all platforms. I can also offer ongoing support and consultations to help you maintain brand consistency as your organization evolves.",
        },
        {
          question: "How do you ensure our brand will be eco-conscious?",
          answer:
            "I place a great emphasis on creating brands that not only resonate with a wide audience but are also eco-conscious. I do this by deeply understanding your organization's purpose and values, particularly in relation to sustainability. I incorporate these principles into your brand identity, ensuring it authentically represents your commitment to the environment.",
        },
      ],
    },
    cta: {
  ...
  design: {
    header: {
      ...
      img: {
        src: "./assets/images/web-design-intro.png",
        alt: "",
      },
    },
    problem: {
    ...
    description: {
      ...
      img: {
        src: "./assets/images/web-design-description.png",
        alt: "",
      },
    },
    plan: {
    ...
    transformation: {
      ...
      img: {
        src: "./assets/images/web-design-transformation.png",
        alt: "",
      },
    },
    faqs: {
      ...
      faqs: [
        {
          ...
          answer:
            "I design custom, responsive, accessible, and sustainable websites for eco-conscious businesses and nonprofits. My focus is on creating user-friendly sites that adhere to WCAG 2.2 accessibility standards and generate a low carbon footprint, making them ideal for organizations with a strong focus on sustainability and inclusivity.",
        },
        {
          question: "How long will the web design process take?",
          answer:
            "The timeline for the web design process can vary greatly depending on the complexity of the project and your specific requirements. I understand the time constraints you are under, and I'm committed to delivering a high-quality, sustainable, and accessible website in a timely manner, while ensuring you're involved at every step.",
        },
        {
        ...
        {
          question: "What is WCAG and why is it important?",
          answer:
        ...
        {
          question: "How do you incorporate sustainability into web design?",
          answer:
  ...
  optimization: {
    header: {
      ...
      img: {
        src: "./assets/images/optimization-intro.png",
        alt: "",
      },
    },
    problem: {
    ...
    description: {
      ...
      img: {
        src: "./assets/images/optimization-description.png",
        alt: "",
      },
    },
    plan: {
    ...
    transformation: {
      ...
      img: {
        src: "./assets/images/optimization-transformation.png",
        alt: "",
      },
    },
    faqs: {
      ...
      faqs: [
        {
          question: "How will website optimization help my organization?",
          answer:
        ...
        {
          question: "Will optimizing my website disrupt my current operations?",
          answer:
            "Not at all. I understand the importance of maintaining your operations during the optimization process. My approach is designed to minimize disruption, and I'll work with you to schedule updates and maintenance during off-peak hours whenever possible. Furthermore, my ongoing maintenance ensures that your website stays in optimal condition without any need for you to divert resources away from your core mission.",
        },
        {
          question: "How long does the optimization process usually take?",
          answer:
  ...
  portfolio: {
    ...
    projects: {
      ...
      projects: [
        ...
        // },
        // {
        //   headline: "Advocating for Pollinator Species Protection",
        //   url: "/",
        // },
        // {
        //   headline: "Fostering Sustainable City Planning Initiatives",
        //   url: "/",
        // },
        {
          headline:
          ...
          // image: "./assets/images/graphical-analysis-desktop-mockup.jpeg",
          image: {
            src: "./assets/images/graphical-analysis-desktop-mockup.jpeg",
        ...
        },
        {
          ...
          // image: "./assets/images/climate-strike-oregon-desktop-mockup.jpeg",
          image: {
            src: "./assets/images/climate-strike-oregon-desktop-mockup.jpeg",
